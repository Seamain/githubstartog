### [Serpentarius13/personal-blog](https://github.com/Serpentarius13/personal-blog)

### [HuLaSpark/HuLa](https://github.com/HuLaSpark/HuLa)
- **Description:** HuLa is a desktop instant messaging app built on Tauri+Vue3 (not just instant messaging)
...
### [unvell/ReoGrid](https://github.com/unvell/ReoGrid)
- **Description:** Fast and powerful .NET spreadsheet component, support data format, freeze, outline, formula calculation, chart, script execution and etc. Compatible with Excel 2007 (.xlsx) format and working on .NET 3.5 (or client profile), WPF and Android platform.
...
### [arkntools/arknights-toolbox](https://github.com/arkntools/arknights-toolbox)
- **Description:** 🔨 Arknights Toolbox, all servers are supported. 明日方舟工具箱，全服支持

### [Mran/githubstartog](https://github.com/Mran/githubstartog)
- **Description:** 将你的星标项目做成前端页面

### [ygsgdbd/V2Bar](https://github.com/ygsgdbd/V2Bar)
- **Description:** A sleek and elegant macOS menu bar application, providing you with quick access to V2EX. 一个简洁优雅的 macOS 菜单栏应用，为你提供快捷的 V2EX 访问体验

### [futo-org/android-keyboard](https://github.com/futo-org/android-keyboard)
- **Description:** Offical FUTO Keyboard Issue Tracker and Source Mirror of https://gitlab.futo.org/keyboard/latinime

### [catppuccin/vendetta](https://github.com/catppuccin/vendetta)
- **Description:** 🌕 Soothing pastel theme for Vendetta, Enmity, Bunny & Revenge!

### [nexpid/BunnyPlugins](https://github.com/nexpid/BunnyPlugins)
- **Description:** A collection of all my awesome plugins for Bunny
...
- **Description:** 明日方舟公开招募计算器

### [inferless/Facebook-bart-cnn](https://github.com/inferless/Facebook-bart-cnn)
- **Description:** BART model pre-trained on English language, and fine-tuned on CNN Daily Mail. It was introduced in the paper BART: Denoising Sequence-to-Sequence Pre-training for Natural Language Generation, Translation, and Comprehension by Lewis et al. and first released in [this repository (https://github.com/pytorch/fairseq/tree/master/examples/bart).

### [electron-vite/electron-vite-react](https://github.com/electron-vite/electron-vite-react)
- **Description:** :electron: Electron + Vite + React + Sass boilerplate.
...
### [ShirasawaSama/CefDetector](https://github.com/ShirasawaSama/CefDetector)
- **Description:** Check how many CEFs are on your computer. 检测你电脑上有几个CEF.

### [kevinhermawan/Ollamac](https://github.com/kevinhermawan/Ollamac)
- **Description:** Mac app for Ollama
...
- **Description:** A revolutionary ORM framework for both java and kotlin.

### [yuanyan3060/ArknightsGameResource](https://github.com/yuanyan3060/ArknightsGameResource)
- **Description:** 明日方舟客户端素材

### [penguin-statistics/frontend-v2](https://github.com/penguin-statistics/frontend-v2)
- **Description:** The frontend of the Penguin Statistics website.

### [penguin-statistics/ecmaworld](https://github.com/penguin-statistics/ecmaworld)
- **Description:** ECMAWorld for Penguin Statistics! This monorepo containing multiple projects and packages for the Penguin Statistics project.
...
- **Description:** 鹰角网络 森空岛终端API接口合集以及文档示例

### [aynakeya/skland-api](https://github.com/aynakeya/skland-api)
- **Description:** 鹰角 森空岛API SDK (非官方)

### [doki-theme/doki-theme-jetbrains](https://github.com/doki-theme/doki-theme-jetbrains)
- **Description:** Cute anime character themes for your JetBrains IDEs.

### [HKTSS/mtr-pids](https://github.com/HKTSS/mtr-pids)
- **Description:** Simulation of Hong Kong's Railway Vision PIDS

### [qianguyihao/Mac-list](https://github.com/qianguyihao/Mac-list)
- **Description:** Mac软件清单、Mac使用技巧整理，正在不断完善中。努力做到最全。
...
### [GcsSloop/MacDeveloper](https://github.com/GcsSloop/MacDeveloper)
- **Description:**  Mac开发者

### [lihaoyun6/Logoer](https://github.com/lihaoyun6/Logoer)
- **Description:** Change the style of the Apple logo in macOS menu bar / 更换macOS菜单栏苹果Logo样式的小工具
...
- **Description:** Amper - a project configuration and build tool with a focus on the user experience and the IDE support

### [Voltstro-Studios/Team-Capture](https://github.com/Voltstro-Studios/Team-Capture)
- **Description:** Team-Capture - A multiplayer FPS game, inspired by games like Quake and TF2. Done in Unity

### [akinmustafa/awesome-unity-games](https://github.com/akinmustafa/awesome-unity-games)
- **Description:** A curated list of useful open-source Unity games.

### [mdgaziur/EditorJS-LaTeX](https://github.com/mdgaziur/EditorJS-LaTeX)
- **Description:** LaTeX block support for EditorJS

### [WebJeffery/editor-js-component](https://github.com/WebJeffery/editor-js-component)
- **Description:** editor.js for Vue and React library

### [Loyalsoldier/clash-rules](https://github.com/Loyalsoldier/clash-rules)
- **Description:** 🦄️ 🎃 👻 Clash Premium 规则集(RULE-SET)，兼容 ClashX Pro、Clash for Windows 等基于 Clash Premium 内核的客户端。

### [ccbikai/loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo.ong](https://github.com/ccbikai/loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo.ong)
...
### [fabirt/podcast-app](https://github.com/fabirt/podcast-app)
- **Description:** Podcast App

### [WrichikBasu/ShakeAlarmClock](https://github.com/WrichikBasu/ShakeAlarmClock)
- **Description:** An alarm clock app for Android which allows you to dismiss the ringing alarm by shaking the phone.

### [sfavors3/Android-Alarm-Clock](https://github.com/sfavors3/Android-Alarm-Clock)
- **Description:** A simple android alarm clock application that requires that you solve a math problem to deactivate the alarm.

### [Ajian-studio/GAHonorClock](https://github.com/Ajian-studio/GAHonorClock)
- **Description:** Imitate the honor phone's clock（仿华为荣耀时钟效果）

### [loonggg/Android-AlarmManagerClock](https://github.com/loonggg/Android-AlarmManagerClock)
- **Description:** 设置闹钟的一个封装的比较全面的demo

### [AvatarQing/MiClockView](https://github.com/AvatarQing/MiClockView)
- **Description:** A duplication of the clock on MIUI v6 

### [philliphsu/ClockPlus](https://github.com/philliphsu/ClockPlus)
- **Description:** Alarm clock, timer, and stopwatch application for Android.
...
### [zq1997/deepin-wine](https://github.com/zq1997/deepin-wine)
- **Description:** 【deepin源移植】Debian/Ubuntu上的QQ/微信快速安装方式

### [NeoApplications/Neo-Backup](https://github.com/NeoApplications/Neo-Backup)
- **Description:** backup manager for android

### [haiwen/seadroid](https://github.com/haiwen/seadroid)
- **Description:** Android client for Seafile

### [zhanghai/MaterialFiles](https://github.com/zhanghai/MaterialFiles)
- **Description:** Material Design file manager for Android

### [IvanVolosyuk/diskusage](https://github.com/IvanVolosyuk/diskusage)
- **Description:** Automatically exported from code.google.com/p/diskusage
...
### [Pool-Of-Tears/Myne](https://github.com/Pool-Of-Tears/Myne)
...
### [emgucv/emgucv](https://github.com/emgucv/emgucv)
- **Description:** Emgu CV is a cross platform .Net wrapper to the OpenCV image processing library.
...
### [C2N14/AutomaThemely](https://github.com/C2N14/AutomaThemely)
- **Description:** Simple, set-and-forget python application for changing between desktop themes according to light and dark hours
...
- **Description:** Xposed module written for my Mix4
...
### [RukkitDev/Rukkit](https://github.com/RukkitDev/Rukkit)
- **Description:** 一个基于Netty框架的铁锈战争第三方服务器。A custom RustedWarfare Server based on Netty framework
...
### [THU-feiyue/docs](https://github.com/THU-feiyue/docs)
- **Description:** 清华大学飞跃手册

### [XIU2/UserScript](https://github.com/XIU2/UserScript)
- **Description:** 🐵 自用的一些乱七八糟 油猴脚本~ 

### [Kr328/ndkbinder-rs](https://github.com/Kr328/ndkbinder-rs)

### [JimmyRice/XbelParser](https://github.com/JimmyRice/XbelParser)
- **Description:** A simple XBEL (XML Bookmark Exchange Language) processing library

### [JimmyRice/libminhaversine](https://github.com/JimmyRice/libminhaversine)
- **Description:** A simple haversine implementation in pure C
...
### [Seamain/Blog-New](https://github.com/Seamain/Blog-New)
- **Description:** Use Astro to bulid my new website

### [Kry9toN/Clash4Magisk](https://github.com/Kry9toN/Clash4Magisk)
...
- **Description:** hosts of block ads
...
### [prefix-dev/rip](https://github.com/prefix-dev/rip)
- **Description:** Solve and install Python packages quickly with rip (pip in Rust)
...
### [JimmyRice/fuck-microsoft](https://github.com/JimmyRice/fuck-microsoft)
- **Description:** Fuck Microsoft
...
### [dgl/paste.sh](https://github.com/dgl/paste.sh)
- **Description:** an encrypted pastebin

### [Tencent/xLua](https://github.com/Tencent/xLua)
- **Description:** xLua is a lua programming solution for  C# ( Unity, .Net, Mono) , it supports android, ios, windows, linux, osx, etc.
...
### [Arispex/awesome-shit-code](https://github.com/Arispex/awesome-shit-code)
- **Description:** Collected some shit code from the internet

### [hooozen/hexo-theme-tranquility](https://github.com/hooozen/hexo-theme-tranquility)
...
### [tonyke-bot/wxapp-otp](https://github.com/tonyke-bot/wxapp-otp)
- **Description:** 微信小程序 OTP 专用库，Port from node-notp and CryptoJS.

### [p455555555/totp](https://github.com/p455555555/totp)
- **Description:** TOTP算法Javascript实现，支持动态密码生成、效验，可以搭配Google Authenticator使用

### [oleksandrbalan/pagecurl](https://github.com/oleksandrbalan/pagecurl)
- **Description:** This library allows to create an effect of turning pages, which can be used in book reader applications, custom on-boarding screens or elsewhere.
...
### [bhaoo/Cuckoo](https://github.com/bhaoo/Cuckoo)
- **Description:** 🍭 一款MD风格的双栏Typecho主题

### [saitamasahil/Pixel-Launcher-Extended](https://github.com/saitamasahil/Pixel-Launcher-Extended)
- **Description:** Pixel Launcher Extended is a Magisk module by TeamFiles with many cool features.

### [jaikeerthick/Composable-Graphs](https://github.com/jaikeerthick/Composable-Graphs)
- **Description:** ✨ A very Minimal, Sleek and Powerful Graph library for Android built with Kotlin & Jetpack Compose
...
### [typlog/china-indie-podcasts](https://github.com/typlog/china-indie-podcasts)
- **Description:** 发现与推荐高质量的中文独立播客
...
- **Description:** 一个可爱而现代的 Hexo 主题

### [yiluyanxia/hexo-theme-antiquity](https://github.com/yiluyanxia/hexo-theme-antiquity)
- **Description:** 一个有点古风的Hexo主题，来自一个不会设计不会配色的前端渣渣。点击这里预览-->

### [dooit-org/dooit](https://github.com/dooit-org/dooit)
- **Description:** An awesome TUI todo manager
...
### [xOS/Config](https://github.com/xOS/Config)
- **Description:** 私人物品

### [fluttercandies/flutter_wechat_assets_picker](https://github.com/fluttercandies/flutter_wechat_assets_picker)
- **Description:** An image picker (also with video and audio) for Flutter projects based on the WeChat's UI.
...
### [Semporia/Quantumult-X](https://github.com/Semporia/Quantumult-X)
- **Description:** Bubble icon、Filter、Rewrite、Scripts ;  🔨：Scripts and icons are suitable for Quantumult X,Surge, Loon

### [mattosaurus/PgpCore](https://github.com/mattosaurus/PgpCore)
- **Description:** .NET Core class library for using PGP

### [ionicfirebaseapp/getwidget](https://github.com/ionicfirebaseapp/getwidget)
...
### [bennyhuo/Kotlin-Tutorials](https://github.com/bennyhuo/Kotlin-Tutorials)
- **Description:** 仓库持续记录以 Kotlin 为基础的视频内容的制作过程
...
### [niuhuan/nhentai-cross](https://github.com/niuhuan/nhentai-cross)
- **Description:** A nhentai client 

### [NoireFHC/NHentai-android](https://github.com/NoireFHC/NHentai-android)
- **Description:** NHentai Android Client with Material Design
...
### [loukai99/shareplay-video-player](https://github.com/loukai99/shareplay-video-player)
- **Description:** 基于splayer的开源代码二次开发，加入多人同播功能，异地恋看电影神器

### [hltj/kotlin-web-site-cn](https://github.com/hltj/kotlin-web-site-cn)
- **Description:** Kotlin 语言中文站
...
### [JimmyRice/Seamet](https://github.com/JimmyRice/Seamet)

### [flutterchina/auto_size](https://github.com/flutterchina/auto_size)
- **Description:** Flutter Auto Size，全局屏幕适配。问题太多，暂不建议大家使用，谢谢！

### [flutterchina/flutter_in_action_2nd](https://github.com/flutterchina/flutter_in_action_2nd)
- **Description:** 《Flutter实战 第二版》 书稿

### [hey-red/Markdown](https://github.com/hey-red/Markdown)
- **Description:** Open source C# implementation of Markdown processor, as featured on Stack Overflow.

### [jsososo/QQMusicApi](https://github.com/jsososo/QQMusicApi)
- **Description:** 基于 Express + Axios 的 QQ音乐接口 nodejs 版
...
- **Description:** 一个优雅且完备的 Python QQ 自动化框架，基于 Mirai API HTTP v2。    Powered by Graia Project.

### [RimoChan/Vtuber_Tutorial](https://github.com/RimoChan/Vtuber_Tutorial)
- **Description:** 【教程】从零开始的自制Vtuber！
...
### [hengg/styled-components-docs-zh](https://github.com/hengg/styled-components-docs-zh)
- **Description:**  💅 styled-components 中文文档翻译 🏇持续施工中
...
- **Description:** 基于 OneBot 标准的 Python 异步 QQ 机器人框架 / Asynchronous QQ robot framework based on OneBot for Python
